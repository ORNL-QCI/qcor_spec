...
\begin{Csynopsis}
    PauliOperator createPauli(SiteMap sitemap, int coef, char* paulistr)
\end{Csynopsis}

\begin{Cppsynopsis}
    PauliOperator qcor::createPauli(std::map<int,string> sitemap, int coef, string paulistr)
\end{Cppsynopsis}
...
\apireturnvalues{
    Returns a single instance of a \DATATYPENAME{PauliOperator}.
}      
