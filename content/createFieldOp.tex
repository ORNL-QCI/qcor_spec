...
\begin{Csynopsis}
    Observable* createFieldOp(char* opType, char* relType, int siteIdx, double complex coef)
\end{Csynopsis}

\begin{Cppsynopsis}
    Observable* qcor::createFieldOp(string opType, string relType, int siteIdx, std::complex coef)
\end{Cppsynopsis}
...
\apireturnvalues{
    Returns a pointer to a single instance of \DATATYPENAME{Observable}.
}      
