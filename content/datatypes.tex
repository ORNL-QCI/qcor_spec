...
\hline
\DATATYPENAME{Observable} & is a Pauli obsevable, stores the data to describe an observable that can be used to map an observable to another observable.  Can be assigned from a CompositeOperator or the observableTransform routine.\\
